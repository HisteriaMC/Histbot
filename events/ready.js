module.exports = async(client) => {
    ...
    client.log(`Le bot a été launch avec ${client.users.cache.size} utilisateurs, dans ${client.channels.cache.size} `+
        `channels et ${client.guilds.cache.size} serveurs.`, 'staff');
};